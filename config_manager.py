...
class ConfigManager:
    def __init__(self):
        ...
        self.ini_data = {
            "PEER": "87.232.123.42:56000",
            "PASSWORD": "KRNT2026",
            "VK_HASH": "https://vk.com/call/join/2WYt7qKS05mwBKisR3N9MCKT94BxVxVFLfT-YEKBiIM",
            "WORKERS": "27"
        }
    ...
    def save_ini(self, peer=None, password=None, vk_hash=None, workers=None):
        ...
        content = [
            ...
            f"PEER={self.ini_data.get('PEER', '87.232.123.42:56000')}",
            "",
            "# Пароль подключения (из него выводится HKDF-SHA256 ключ)",
            f"PASSWORD={self.ini_data.get('PASSWORD', 'KRNT2026')}",
            "",
    ...
    def peer(self):
        self.load_ini()
        return self.ini_data.get("PEER", "87.232.123.42:56000")

    @property
    def password(self):
        self.load_ini()
        return self.ini_data.get("PASSWORD", "KRNT2026")
